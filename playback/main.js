...
var $author$project$Main$init = function (flags) {
	...
	var initialStatus = $author$project$KeseRimaTypes$NothingSelected(
		{
			board: $author$project$KeseRimaTypes$initialBoard(
				{keseDice: keseDice, rimaDice: rimaDice, shipDice: shipDice}),
											...
											if (A2($elm$core$String$right, 1, historyFirst) === 'K') {
												...
												if (_v3.$ === 'Just') {
													...
													return _Debug_todo(
														'Main',
														{
															start: {line: 164, column: 49},
															end: {line: 164, column: 59}
												...
												if (A2($elm$core$String$right, 1, historyFirst) === 'K') {
													...
													if (_v4.$ === 'Just') {
														...
														return _Debug_todo(
															'Main',
															{
																start: {line: 193, column: 49},
																end: {line: 193, column: 59}
															})('cannot find an adequate piece in Kese\'s Hand 2');
													}
												} else {
													var _v5 = A2(
													...
													if (_v5.$ === 'Just') {
														...
														return _Debug_todo(
															'Main',
															{
																start: {line: 203, column: 49},
																end: {line: 203, column: 59}
															})('cannot find an adequate piece in Rima\'s Hand 2');
													}
												}
											}();
