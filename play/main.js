...
var $author$project$Main$Circle = {$: 'Circle'};
...
var $author$project$Main$numToProf = function (n) {
	switch (n) {
		case 0:
			return $author$project$Main$Circle;
		case 1:
			return $author$project$Main$HorizontalVertical;
		default:
			return $author$project$Main$Diagonal;
	}
};
...
var $author$project$Main$isVictorious = function (list) {
	return A2($elm$core$List$member, $author$project$Main$All, list) || A2(
		$elm$core$List$all,
		function (p) {
			return A2($elm$core$List$member, p, list);
		},
		_List_fromArray(
			[$author$project$Main$Diagonal, $author$project$Main$HorizontalVertical, $author$project$Main$Circle]));
};
			...
			switch (_v0.a.$) {
					...
					switch (_v0.b.$) {
						...
						case 'MovementToward':
							...
							switch (from.$) {
								case 'PieceOnTheBoard':
									var coord = from.a;
									var _v5 = A2($author$project$Main$robFocusedPieceFromBoard, coord, cardState.board);
									if (_v5.$ === 'Nothing') {
										return modl;
									} else {
										var _v6 = _v5.a;
										var piece = _v6.a;
										var robbedBoard = _v6.b;
								...
								case 'PieceInKeseHand':
									...
									var newBoard = _Utils_ap(
										A2(
											...
											profs),
										cardState.board);
									var _v8 = _Utils_Tuple2(newKeseHand, cardState.keseDeck);
									if ((((!_v8.a.b) && _v8.b.b) && _v8.b.b.b) && _v8.b.b.b.b) {
										var _v9 = _v8.b;
										var x = _v9.a;
										var _v10 = _v9.b;
										var y = _v10.a;
								...
								default:
									var ind = from.a;
									var _v12 = A2($author$project$Main$robIth, ind, cardState.rimaHand);
									var profs = _v12.a;
									var newRimaHand = _v12.b;
									var newBoard = _Utils_ap(
										A2(
											$elm$core$List$map,
											function (prof) {
											...
											profs),
										cardState.board);
									var _v13 = _Utils_Tuple2(newRimaHand, cardState.rimaDeck);
									if ((((!_v13.a.b) && _v13.b.b) && _v13.b.b.b) && _v13.b.b.b.b) {
										var _v14 = _v13.b;
										var x = _v14.a;
										var _v15 = _v14.b;
										var y = _v15.a;
				...
				case 'AfterSacrifice':
					if (_v0.b.$ === 'MovementToward') {
						var _v17 = _v0.a;
						var mover = _v17.b.mover;
						var remaining = _v17.b.remaining;
						var to = _v0.b.a;
						return $author$project$Main$NowWaitingForAdditionalSacrifice(
							{
								mover: _Utils_update(
...
var $author$project$Main$glyph = F2(
	function (profession, color) {
		...
		switch (profession.$) {
			...
			default:
				return _Utils_ap(
					A2($author$project$Main$glyph, $author$project$Main$HorizontalVertical, color),
					_Utils_ap(
						A2($author$project$Main$glyph, $author$project$Main$Diagonal, color),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill(
						$author$project$Main$backgroundColor(p.pieceColor)),
						$elm$svg$Svg$Attributes$stroke('#ffff00'),
